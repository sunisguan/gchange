...
def timestamp_to_strtime_10(timestamp):
    """将 13 位整数的毫秒时间戳转化成本地普通时间 (字符串格式)
    :param timestamp: 13 位整数的毫秒时间戳 (1456402864242)
    :return: 返回字符串格式 {str}'2016-02-25 20:21:04.242000'
    """
    local_str_time = datetime.fromtimestamp(int(timestamp)).strftime('%Y-%m-%d %H:%M:%S')
    return local_str_time
...
def datetime_to_timestamp_10(datetime_obj):
    """将本地(local) datetime 格式的时间 (含毫秒) 转为毫秒时间戳
    :param datetime_obj: {datetime}2016-02-25 20:21:04
    :return: 13 位的毫秒时间戳  1456402864242
    """
...
def strtime_to_datetime_10(timestr):
    """将字符串格式的时间 (含毫秒) 转为 datetiem 格式
    :param timestr: {str}'2016-02-25 20:21:04.242'
    :return: {datetime}2016-02-25 20:21:04.242000
    """
...
def strtime_to_timestamp_10(local_timestr):
    local_datetime = strtime_to_datetime_10(local_timestr)
    timestamp = datetime_to_timestamp_10(local_datetime)
    return timestamp
